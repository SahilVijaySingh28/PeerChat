      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-xl border">
        ...
        <div className="space-y-4">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border rounded-lg bg-secondary hover:bg-secondary/80 transition-colors disabled:opacity-50"
          >
